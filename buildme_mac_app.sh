...
echo "  dist/${ZIP_NAME}"
echo "  packaging/HANDOVER-MAC-APP-STORE.md"
echo "  packaging/Neight.entitlements"
echo "Refresh the artifact hash in that document"
echo "first -- this build just changed it."
echo "========================================"
